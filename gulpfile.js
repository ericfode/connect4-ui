...
gulp.task('css-bundle', function() {
  ...
  return gulp
    ...
    .pipe(gulp.dest('./urbit/app/connect4/css'));
});
...
gulp.task('js-imports', function(cb) {
  return gulp.src('dist/index.js')
    ...
    .pipe(gulp.dest('./urbit/app/connect4/js/'))
    .on('end', cb);
});
...
gulp.task('js-minify', function () {
  return gulp.src('./urbit/app/connect4/js/index.js')
    .pipe(minify())
    .pipe(gulp.dest('./urbit/app/connect4/js/'));
});

gulp.task('tile-js-minify', function () {
  return gulp.src('./urbit/app/connect4/js/tile.js')
    .pipe(minify())
    .pipe(gulp.dest('./urbit/app/connect4/js/'));
});
